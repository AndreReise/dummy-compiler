...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 37; i <= 37; ++i) start[i] = 1;
		for (int i = 42; i <= 43; ++i) start[i] = 1;
		for (int i = 47; i <= 47; ++i) start[i] = 1;
		for (int i = 45; i <= 45; ++i) start[i] = 13;
		for (int i = 33; i <= 33; ++i) start[i] = 2;
		for (int i = 61; i <= 61; ++i) start[i] = 14;
		for (int i = 62; i <= 62; ++i) start[i] = 15;
		for (int i = 60; i <= 60; ++i) start[i] = 16;
		for (int i = 65; i <= 90; ++i) start[i] = 4;
		for (int i = 97; i <= 122; ++i) start[i] = 4;
		for (int i = 48; i <= 57; ++i) start[i] = 17;
		for (int i = 59; i <= 59; ++i) start[i] = 12;
		start[40] = 20; 
		start[41] = 21; 
		start[123] = 22; 
		start[125] = 23; 
